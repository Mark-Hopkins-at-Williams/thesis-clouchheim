...
similar_lang_tag = 'grn_Latn' ####### THIS HAS NOT BEEN IMPLEMENTED YET
model = update_model_for_new_token(model, tokenizer, similar_lang_tag)
    
# train model
print('starting training')
train_model(model, tokenizer, df_train, df_dev, SRC_LANG[2], lang_tags, MODEL_SAVE_PATH, training_steps = 2000)
