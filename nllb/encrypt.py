...
def create_tokenized(tokenizer, sents, return_tensors='pt'):
    return tokenizer(sents, return_tensors=return_tensors, padding=True, truncation=True, max_length=128) 

def create_token_permuter(tokenizer, tokenized):
...
def encrypt_sentences(tokenizer, tokenized, permuter):
